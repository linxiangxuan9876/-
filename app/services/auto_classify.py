...
def keyword_match(question: str) -> Optional[Dict[str, str]]:
    ...
    combo_keywords = [
        ...
        (["营业", "时间"], "门店服务与活动", "营业时间与设施"),
        (["运营", "时间"], "门店服务与活动", "营业时间与设施"),
        (["预约", "取车"], "门店服务与活动", "预约与取送车流程"),
        (["送车", "服务"], "门店服务与活动", "预约与取送车流程"),
        (["优惠", "券"], "门店服务与活动", "优惠券与活动"),
        (["免费", "午餐"], "门店服务与活动", "营业时间与设施"),
        (["免费", "餐"], "门店服务与活动", "营业时间与设施"),
        (["休息", "室"], "门店服务与活动", "营业时间与设施"),
        ...
        # 车辆技术与使用类 - 精确组合
        (["仪表", "故障"], "车辆技术与使用", "仪表盘故障报警"),
        (["仪表", "报警"], "车辆技术与使用", "仪表盘故障报警"),
        (["故障", "灯"], "车辆技术与使用", "仪表盘故障报警"),
        (["电池", "续航"], "车辆技术与使用", "电池与能耗"),
        (["电池", "电量"], "车辆技术与使用", "电池与能耗"),
        (["能耗", "多少"], "车辆技术与使用", "电池与能耗"),
        (["功能", "使用"], "车辆技术与使用", "车辆功能使用说明"),
        (["怎么", "用"], "车辆技术与使用", "车辆功能使用说明"),

        # 金融保险与理赔类
        (["出险", "理赔"], "金融保险与理赔", "出险与理赔流程"),
        (["保险", "购买"], "金融保险与理赔", "保险购买与续保"),
        (["保险", "续保"], "金融保险与理赔", "保险购买与续保"),
        (["贷款", "解压"], "金融保险与理赔", "贷款解压与绿本"),
        (["绿本", "领取"], "金融保险与理赔", "贷款解压与绿本"),
    ]
    ...
    # ========== 第二优先级：强特征单关键词 ==========
    # 这些词具有强分类特征，单独出现也能确定分类
    strong_keywords = {
        # 门店服务与活动类 - 优先
        "门店电话": ("门店服务与活动", "营业时间与设施"),
        "门店地址": ("门店服务与活动", "营业时间与设施"),
        "门店位置": ("门店服务与活动", "营业时间与设施"),
